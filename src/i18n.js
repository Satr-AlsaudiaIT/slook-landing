...
export const content = {
  ar: {
    ...
    apply: {
      ...
      title: 'قدم طلبك',
      sub: 'عبّي البيانات وراح نتواصل معك قريب.',
      form: {
        fullName: 'الاسم الكامل',
        email: 'البريد الإلكتروني',
        phone: 'رقم الجوال',
        description: 'كيف باع أول بيعة؟',
        descriptionHint: 'احكي لنا عن أول تجربة بيع.',
  ...
  en: {
    ...
    apply: {
      ...
      title: 'Apply now',
      sub: 'Fill in your details — we\'ll be in touch soon.',
      form: {
        fullName: 'Full name',
        email: 'Email',
        phone: 'Phone number',
        description: 'How did you make your first sale?',
        descriptionHint: 'Tell us about your first selling experience.',
