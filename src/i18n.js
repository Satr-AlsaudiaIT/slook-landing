...
export const content = {
  ar: {
    ...
    services: {
      ...
      offlineLabel: 'خدمات التسويق الغير الرقمية',
      trainingLabel: 'التدريب والتمكين',
      digital: [
        {
          n: '01',
          title: 'فحص سلوك',
          body: 'تحليل شامل لوضعك الحالي، نفهم نقاط القوة والضعف ونوضح المسار الصحيح.',
        },
        {
          n: '02',
          title: 'سلوك المتاجر الرقمية',
          body: 'إدارة كاملة لمتجرك الإلكتروني من التصميم للمحتوى إلى عملية البيع والتحليل.',
        },
        {
          n: '03',
          title: 'سلوك الحملات الممولة',
          body: 'حملات إعلانية ممولة محترفة على جميع المنصات، مصممة لتحقيق أهدافك بفعالية.',
        },
        {
          n: '04',
          title: 'سلوك حسابات التواصل',
          body: 'إدارة متكاملة لحساباتك على وسائل التواصل بمحتوى مخطط ومنظم يكبر حضورك.',
        },
        {
          n: '05',
          title: 'سلوك صفحات الهبوط',
          body: 'صفحات هبوط مصممة للتحويل، بنصوص ذكية وتصميم احترافي يقنع الزائر.',
        },
        {
          n: '06',
          title: 'سلوك برامج الولاء',
          body: 'برامج ولاء ذكية تخلي عميلك يرجع لك دائماً بحوافز تعزز الارتباط بعلامتك.',
        },
        {
          n: '07',
          title: 'سلوك الصوت الإعلامي',
          body: 'نبني لك صوت وأسلوب خاص يميزك، سواء كنت قائد، رائد أعمال أو مؤثر.',
        },
      ],
      offline: [
        {
          n: '08',
          title: 'سلوك الهوية التجارية',
          body: 'نصمم هوية بصرية ورسائل واضحة تعكس شخصيتك وتخلي علامتك تبقى في ذهن العميل.',
        },
        {
          n: '09',
          title: 'سلوك الملف التعريفي',
          body: 'نجهز ملف تعريفي منظّم واحترافي يعرضك قدّام العملاء والشركاء بثقة.',
        },
        {
          n: '10',
          title: 'سلوك المواد المؤسسية',
          body: 'ننتج مواد مؤسسية متكاملة من عروض وتقارير وبطاقات عمل تعزز مصداقيتك.',
        },
        {
          n: '11',
          title: 'سلوك الحملات الخارجية والتفعيل الميداني',
          body: 'نخطط وننفّذ حملات خارجية وتفعيل ميداني يخلي علامتك تنشاف وتؤثر في السوق.',
        },
        {
          n: '12',
          title: 'سلوك الفعاليات',
          body: 'نبتكر وننفّذ فعاليات متكاملة تخلق تجربة حقيقية وتخلّي الجمهور يتذكرك.',
        },
        {
          n: '13',
          title: 'سلوك الهدايا التذكارية',
          body: 'نصمم هدايا تذكارية بهوية علامتك، تترك انطباع وتربط العميل فيك.',
        },
      ],
      training: [
        {
          n: '14',
          title: 'سلوك التدريب التسويقي',
          body: 'دورات متخصصة وعملية تطور مهاراتك التسويقية وترفع كفاءتك في البيع والتسويق.',
        },
        {
          n: '15',
          title: 'سلوك تاجر',
          body: 'برنامج تمكين شامل يعلمك كيف تبدأ تجارة، تختبر السوق، وتصنع دخلك بنفسك.',
        },
      ],
    },
    clients: {
